...
region_cell = fread(paste0(data_dir, '20200904_region_cell_abundances_one_section.csv'))
region_cell[, c('V1', 'subregion') := NULL]

region_cell$region_final_colors = toupper(region_cell$region_final_colors)
region_final_int = region_cell$region_final
region_cell$region_final = paste0('r', as.character(region_cell$region_final))
region_cell$region_final = factor(region_cell$region_final, paste0('r', as.character(sort(region_final_int))))
region_cell[cortical_layer != '', region_final := paste0(cortical_layer, '_', region_final)]
region_cell[, c('cortical_layer') := NULL]
...
## Make color palettes
reg_cl_pal <- setNames(as.character(region_cell$region_final_colors),
as.character(region_cell$region_final))
...
region_cell_annot = as.data.frame(region_cell_mat[, .(region_final, location)])
rownames(region_cell_annot) = region_cell_annot$region_final
region_cell_mat[, c('location', 'region_final_colors') := NULL]

region_cell_mat = t(as.matrix(region_cell_mat, rownames='region_final'))
...
pmap <- pheatmap::pheatmap(region_cell_mat, 
                           ...
                           annotation_colors = list(region_final=reg_cl_pal, location=brain_reg_pal), 
                           fontsize = 10,
                           filename=paste0(data_dir, "plots/figures/Fig3E_Supl_location_pheatmap_one_section.pdf"), 
                           width=8.5*1.2, height=9*1.2
                           );
pmap <- pheatmap::pheatmap(region_cell_mat, 
                           show_colnames = T, angle_col=90,
                           annotation_names_col=T,
                           ...
                           annotation_colors = list(region_final=reg_cl_pal, location=brain_reg_pal), 
                           fontsize = 10,
                           filename=paste0(data_dir, "plots/figures/Fig3E_Supl_location_pheatmap_one_section.png"), 
                           width=8.5*1.2, height=9*1.2
                           );
knitr::include_graphics(paste0(data_dir, "plots/figures/Fig3E_Supl_location_pheatmap_one_section.png"))
```

## Plot heatmap for Fig3E

```{r Fig3E_pheatmap, echo=TRUE, fig.width = 10.2, fig.height = 10.8}
astro_region_cell = region_cell[, .SD, .SDcols = patterns('Astro|region_final|location|region_final_colors')]
## Make color palettes
reg_cl_pal <- setNames(as.character(astro_region_cell$region_final_colors),
as.character(astro_region_cell$region_final))
...
pmap <- pheatmap::pheatmap(region_cell_mat, 
                           ...
                           annotation_colors = list(region_final=reg_cl_pal, location=brain_reg_pal), 
                           fontsize = 10,
                           filename=paste0(data_dir, "plots/figures/Fig3E_astro_location_pheatmap_one_section.pdf"), 
                           width=8.5*1.2, height=9*1.2
                           #labels_col=paste0()
                           );
pmap <- pheatmap::pheatmap(region_cell_mat, 
                           ...
                           annotation_colors = list(region_final=reg_cl_pal, location=brain_reg_pal), 
                           fontsize = 10,
                           filename=paste0(data_dir, "plots/figures/Fig3E_astro_location_pheatmap_one_section.png"), 
                           width=8.5*1.2, height=9*1.2
                           );
write.csv(as.data.frame(region_cell_mat), paste0(data_dir, "plots/figures/Fig3E_astro_location_pheatmap_one_section.csv"))

knitr::include_graphics(paste0(data_dir, "plots/figures/Fig3E_astro_location_pheatmap_one_section.png"))
```