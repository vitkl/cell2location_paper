...
write.csv(as.data.frame(region_cell_mat[pmap$tree_row$labels[pmap$tree_row$order],]), paste0(data_dir, "plots/figures/Fig3E_Supl_location_pheatmap.csv"))
knitr::include_graphics(paste0(data_dir, "plots/figures/Fig3E_Supl_location_pheatmap.png"))
```

## Plot heatmap for Fig3E

```{r Fig3E_pheatmap, echo=TRUE, fig.width = 10.2, fig.height = 11.8}
