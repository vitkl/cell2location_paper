---
title: "Fig3D_astrocytes_across_brain_regions"
author: "Vitalii Kleshchevnikov"
date: "15/09/2020"
output: html_document
---

rmarkdown::render(input = paste0("/nfs/team205/vk7/sanger_projects/cell2location_paper/notebooks/mouse_brain_visium/analysis_4_Fig3D_astrocytes_across_brain_regions.Rmd"), 
                  output_format = "html_document", 
                  output_file=paste0("/nfs/team205/vk7/sanger_projects/cell2location_paper/notebooks/mouse_brain_visium/analysis_4_Fig3D_astrocytes_across_brain_regions.html"))
...
```{r read}
data_dir = '/nfs/team205/vk7/sanger_projects/cell2location_paper/notebooks/selected_results/mouse_visium_snrna/scvi/'
...
region_cell = fread(paste0(data_dir, run_name, '/20200904_region_cell_abundances.csv'))
...
```{r Fig3D_suppl_pheatmap, echo=TRUE, fig.width = 10.2, fig.height = 10.8}
## Make color palettes
...
pmap <- pheatmap::pheatmap(region_cell_mat, 
                           ...
                           fontsize = 10,
                           filename=paste0(data_dir, run_name, "/figures/Fig3D_Supl_location_pheatmap.pdf"), 
                           width=8.5*1.2, height=9*1.4
                           );
#pmap <- pheatmap::pheatmap(region_cell_mat, 
#                           show_colnames = T, angle_col=90,
#                           annotation_names_col=T,
...
#                           annotation_colors = list(region_label=reg_cl_pal, location=brain_reg_pal), 
#                           fontsize = 10,
#                           filename=paste0(data_dir, run_name, "/figures/Fig3D_Supl_location_pheatmap.png"), 
#                           width=8.5*1.2, height=9*1.4
#                           );

write.csv(as.data.frame(region_cell_mat[pmap$tree_row$labels[pmap$tree_row$order],]), paste0(data_dir, run_name, "/figures/Fig3D_Supl_location_pheatmap.csv"))
#knitr::include_graphics(paste0(data_dir, run_name, "/figures/Fig3D_Supl_location_pheatmap.png"))
```

## Plot heatmap for Fig3D

```{r Fig3D_pheatmap, echo=TRUE, fig.width = 10.2, fig.height = 11.8}
...
pmap <- pheatmap::pheatmap(region_cell_mat, 
                           ...
                           annotation_colors = list(region_label=reg_cl_pal, location=brain_reg_pal), 
                           fontsize = 10,
                           filename=paste0(data_dir, run_name, "/figures/Fig3D_astro_location_pheatmap.pdf"), 
...
#                           annotation_colors = list(region_label=reg_cl_pal, location=brain_reg_pal), 
#                           fontsize = 10,
#                           filename=paste0(data_dir, run_name, "/figures/Fig3D_astro_location_pheatmap.png"), 
#                           width=8.5*1.2, height=9*1.3
#                           );
write.csv(as.data.frame(region_cell_mat), paste0(data_dir, run_name, "/figures/Fig3D_astro_location_pheatmap.csv"))

#knitr::include_graphics(paste0(data_dir, run_name, "/figures/Fig3D_astro_location_pheatmap.png"))
```