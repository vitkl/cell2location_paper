...
pmap <- pheatmap::pheatmap(region_cell_mat, 
                           ...
                           fontsize = 10,
                           filename=paste0(data_dir, "plots/figures/Fig3D_Supl_location_pheatmap.pdf"), 
...
pmap <- pheatmap::pheatmap(region_cell_mat, 
                           ...
                           annotation_colors = list(region_label=reg_cl_pal, location=brain_reg_pal), 
                           fontsize = 10,
                           filename=paste0(data_dir, "plots/figures/Fig3D_Supl_location_pheatmap.png"), 
                           width=8.5*1.2, height=9*1.4
                           );

write.csv(as.data.frame(region_cell_mat[pmap$tree_row$labels[pmap$tree_row$order],]), paste0(data_dir, "plots/figures/Fig3D_Supl_location_pheatmap.csv"))
knitr::include_graphics(paste0(data_dir, "plots/figures/Fig3D_Supl_location_pheatmap.png"))
```
...
pmap <- pheatmap::pheatmap(region_cell_mat, 
                           ...
                           annotation_colors = list(region_label=reg_cl_pal, location=brain_reg_pal), 
                           fontsize = 10,
                           filename=paste0(data_dir, "plots/figures/Fig3D_astro_location_pheatmap.pdf"), 
...
pmap <- pheatmap::pheatmap(region_cell_mat, 
                           ...
                           annotation_colors = list(region_label=reg_cl_pal, location=brain_reg_pal), 
                           fontsize = 10,
                           filename=paste0(data_dir, "plots/figures/Fig3D_astro_location_pheatmap.png"), 
                           width=8.5*1.2, height=9*1.3
                           );
write.csv(as.data.frame(region_cell_mat), paste0(data_dir, "plots/figures/Fig3D_astro_location_pheatmap.csv"))

knitr::include_graphics(paste0(data_dir, "plots/figures/Fig3D_astro_location_pheatmap.png"))
```