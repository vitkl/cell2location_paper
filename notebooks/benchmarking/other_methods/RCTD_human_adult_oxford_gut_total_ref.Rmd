...
rmarkdown::render(input = paste0("/nfs/team205/vk7/sanger_projects/cell2location_paper/notebooks/benchmarking/other_methods/RCTD_human_adult_oxford_gut_total_ref.Rmd"), 
                  output_format = "html_document", 
                  output_file=paste0("/nfs/team205/vk7/sanger_projects/cell2location_paper/notebooks/benchmarking/other_methods/RCTD_human_adult_oxford_gut_total_ref.html"))
...
#puck$cell_type_names = as.character(unique(sc_seu@meta.data$Integrated_05))
#factor(as.character(sc_seu@meta.data$Integrated_05))
# the column for annotations is hard-coded
#sc_seu@meta.data$cell_types = sc_seu$Integrated_05
#sc_seu@cell_types = sc_seu@meta.data$Integrated_05

sc_seu$total_counts = Matrix::colSums(sc_seu@assays$RNA@counts)
nUMI = sc_seu$total_counts
#names(nUMI) = colnames(sc_seu)
cell_types = sc_seu$Integrated_05
...
time = microbenchmark::microbenchmark({
  myRCTD <- create.RCTD(spatialRNA=puck, reference=reference, 
                        ...
                        CELL_MIN_INSTANCE=5, #cell_type_names=unique(as.character(sc_seu@meta.data$Integrated_05)),
                        max_cores = 10)
...
fwrite(results_weights, paste0(rctd_results, 'results_selected_weights_133clusters.csv'))
```