...
rmarkdown::render(input = paste0("./RCTD_human_fetal_gut.Rmd"), 
                  output_format = "html_document", 
                  output_file=paste0("./RCTD_human_fetal_gut.html"))
...
fwrite(results_weights, paste0(rctd_results, 'results_weights_65clusters.csv'))
```